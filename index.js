        ...
        xAxis: [
            {
                ...
                type: 'category',
                // 使用 data 中的数据设为刻度文字
                data: ['省级勘察', '全国勘察', '全国优质', '国家优秀', '科技奖', '军委后勤', '国际滑坡', '詹天佑奖'],
                // 刻度设置
                axisTick: {
                    // true意思：图形在刻度中间
                    // false意思：图形在刻度之间
...
// 资质情况模块
(function () {
    var $qualificationPanel = $('.qualification');
    if ($qualificationPanel.length === 0) return;
    
    var $tabs = $qualificationPanel.find('.tabs a');
    var $contents = $qualificationPanel.find('.content');
    var currentIndex = 0;
